...
def run():
    st.markdown(
        ...
        Check out the [Predict Page](https://visuway.tech/Predict_Page) to try it on an image!
        
        The project is still developing and predictions improving! Check out the [Data Page](https://visuway.tech/Data_Page) to see the some of the most 
